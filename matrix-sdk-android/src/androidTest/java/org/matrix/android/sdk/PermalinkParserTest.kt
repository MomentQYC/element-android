...
class PermalinkParserTest {
    ...
    fun testParseEmailInvite() {
        ...
        """.trimIndent()
                .replace("https://hashi.sbs/#/room/", "https://go.hashi.sbs/#/")
    ...
    fun testParseLinkWIthEvent() {
        val rawInvite =
                "https://go.hashi.sbs/#/!OGEhHVWSdvArJzumhm:matrix.org/\$xuvJUVDJnwEeVjPx029rAOZ50difpmU_5gZk_T0jGfc?via=matrix.org&via=libera.chat&via=matrix.example.io"
